...
const Hero = () => {
    ...
    // const logos = [
    //     { src: 'https://saasly.prebuiltui.com/assets/companies-logo/instagram.svg', alt: 'Instagram' },
    //     { src: 'https://saasly.prebuiltui.com/assets/companies-logo/framer.svg', alt: 'Framer' },
    //     { src: 'https://saasly.prebuiltui.com/assets/companies-logo/microsoft.svg', alt: 'Microsoft' },
    //     { src: 'https://saasly.prebuiltui.com/assets/companies-logo/huawei.svg', alt: 'Huawei' },
    //     { src: 'https://saasly.prebuiltui.com/assets/companies-logo/walmart.svg', alt: 'Walmart' },
    // ];
    const logos = [
        // { src: 'https://saasly.prebuiltui.com/assets/companies-logo/instagram.svg', alt: 'Instagram' },
        // { src: 'https://saasly.prebuiltui.com/assets/companies-logo/framer.svg', alt: 'Framer' },
